const menuHome = () => { 
    ...
    document.getElementById("menuGame").style = "color: white; background-color: #298b5;"
    document.getElementById("menuJukebox").style = "color: white; background-color: #298b5;"
...
const menuJukebox = () => { 
    ...
    document.getElementById("menuGame").style = "color: white; background-color: #298b5;"
    document.getElementById("menuHome").style = "color: white; background-color: #298b5;"
}
const menuGame = () => { 
